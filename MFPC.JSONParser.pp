...
{$mode objfpc}
{$h+}
unit MFPC.JSONParser;

interface

uses
  //Classes, 
  SysUtils, MFPC.fpJSON, MFPC.JSONScanner, MFPC.JSONReader,
  //MFPC_Classes_SHARED,
...
Type
  ...
  EJSONParser = MFPC_JSONReader.EJSONParser;
...
procedure DefJSONParserHandler(AStream: TM_Stream; const AUseUTF8: Boolean; out
  Data: TJSONData);
