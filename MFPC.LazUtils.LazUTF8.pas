...

{
  ...
  =================================================
  Original file: lazarus\components\lazutils\lazutf8.pas
  The "lazarus\components\lazutils\" directory must be added to project's include files (-Fi)

}

unit MFPC.LazUtils.LazUTF8;
...
//uses
//  gettext
{$IFDEF Darwin}uses MacOSAll;{$ENDIF}
//  ;
