...
unit MFPC.JSONScanner;

interface

uses
  SysUtils,
  MFPC.Classes.SHARED, MFPC.Classes.Streams, JPL.StrList, JPL.StrList.MFPC.Helper
  //Classes
  ;
...
Type
  ...
  public
    constructor Create(Source : TM_Stream; AUseUTF8 : Boolean = True); overload; deprecated 'use options form instead';
    constructor Create(const Source : String; AUseUTF8 : Boolean = True); overload; deprecated  'use options form instead';
    constructor Create(Source: TM_Stream; AOptions: TJSONOptions); overload;
...
constructor TJSONScanner.Create(Source : TM_Stream; AUseUTF8 : Boolean = True);
...
constructor TJSONScanner.Create(Source: TM_Stream; AOptions: TJSONOptions);
begin
  FSource:=TJPStrList.Create;
