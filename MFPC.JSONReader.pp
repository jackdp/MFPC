...
{$mode objfpc}
{$h+}
unit MFPC.JSONReader;

interface

uses
  //Classes, 
  SysUtils, MFPC.fpJSON, MFPC.JSONScanner,
...
constructor TBaseJSONReader.Create(Source: TM_Stream; AUseUTF8 : Boolean = True);
begin
  Inherited Create;
...
constructor TBaseJSONReader.Create(Source: TM_Stream; AOptions: TJSONOptions);
begin
